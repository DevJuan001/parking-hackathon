...
public class ValidarUsuarioCreado implements Question<Boolean> {
    private static final Logger logger = LoggerFactory.getLogger(ValidarUsuarioCreado.class);

    private static final String MENSAJE_ESPERADO = "Usuario creado exitosamente";

    public static ValidarUsuarioCreado validar() {
