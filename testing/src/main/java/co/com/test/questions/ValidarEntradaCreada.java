...
public class ValidarEntradaCreada implements Question<Boolean> {
    private static final Logger logger = LoggerFactory.getLogger(ValidarEntradaCreada.class);

    private static final String MENSAJE_ESPERADO = "Entrada creada exitosamente";

    public static ValidarEntradaCreada validar() {
        return new ValidarEntradaCreada();
    }
