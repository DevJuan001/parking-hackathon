...
public class ValidarEmailEditado implements Question<Boolean> {
    private static final Logger logger = LoggerFactory.getLogger(ValidarEmailEditado.class);

    private static final String MENSAJE_ESPERADO = "Email editado exitosamente";

    public static ValidarEmailEditado validar() {
        return new ValidarEmailEditado();
    }
